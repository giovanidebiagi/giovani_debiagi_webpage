...
class MechatronicsProjectsListWidget extends StatefulWidget {
  ...
  @override
  State<MechatronicsProjectsListWidget> createState() => _MechatronicsProjectsListWidgetState();
}

class _MechatronicsProjectsListWidgetState extends State<MechatronicsProjectsListWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<GetMechatronicsProjectsBloc, IMechatronicsProjectsState>(
        builder: (context, state) {
          if (state is EmptyMechatronicsProjectsState) {
            ...
            return const Text('There has been an error on getting Mechatronics Projects.');
