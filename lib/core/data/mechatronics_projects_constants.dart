  ...
  static const List<Map<String, dynamic>> mechatronicsProjects = [
    {
      ...
      "projectImagesPaths": [
        "lib/core/data/assets/images/mechatronics_projects/images/qctimu/1.png",
        "lib/core/data/assets/images/mechatronics_projects/images/qctimu/2.png",
        "lib/core/data/assets/images/mechatronics_projects/images/qctimu/3.png",
      ],
      "videosUrl":
    ...
    },
    {
      ...
      "projectImagesPaths": [
        "lib/core/data/assets/images/mechatronics_projects/images/wall_climbing_autonomous_robot/1.png",
        "lib/core/data/assets/images/mechatronics_projects/images/wall_climbing_autonomous_robot/2.png",
        "lib/core/data/assets/images/mechatronics_projects/images/wall_climbing_autonomous_robot/3.png",
      ],
    },
  ];
}
